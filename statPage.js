...
else if (cash > mj && acdc && bruce && abba && elvis && acdc && mc && bob && elton && queen && beatles) {
...
else if (abba > mj && acdc && bruce && cash && elvis && acdc && mc && bob && elton && queen && beatles) {
    img.src = "https://www.ft.com/__origami/service/image/v2/images/raw/ftcms%3A68cb1de8-cbdd-11e8-8d0b-a6539b949662?source=ig";
}
else if (elton > mj && acdc && bruce && abba && elvis && acdc && mc && bob && cash && queen && beatles) {
    img.src = "https://static-cdn.sr.se/images/2794/c4d9a082-b2a8-412b-8d3e-5844e3f862c4.jpg";
}
else if (mj > cash && acdc && bruce && abba && elvis && acdc && mc && bob && elton && queen && beatles) {
...
else if (bruce > mj && acdc && cash && abba && elvis && acdc && mc && bob && elton && queen && beatles) {
...
else if (bob > mj && acdc && bruce && abba && elvis && acdc && mc && cash && elton && queen && beatles) {
    img.src = "https://www.rollingstone.com/wp-content/uploads/2020/01/Bob-Marley-Lead.jpg?w=1581&h=1054&crop=1";
}
else if (beatles > mj && acdc && bruce && abba && elvis && acdc && mc && bob && elton && queen && cash) {
...
else if (mc > mj && acdc && bruce && abba && elvis && acdc && cash && bob && elton && queen && beatles) {
...
else if (elvis > mj && acdc && bruce && abba && cash && acdc && mc && bob && elton && queen && beatles) {
...
else if (queen > mj && acdc && bruce && abba && elvis && acdc && mc && bob && elton && cash && beatles) {
